...
@WebServlet(value = "/SearchStudentById")
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (firstStudent!=null) {
			...
			if (foundStudent!=null) {
				...
				session.setAttribute("enrollment_id", s_id);
				...
				printWriter.print("<!DOCTYPE html>\r\n"
						...
						+ "        }\r\n"
						+ "        form h4{\r\n"
						+ "        	   margin : -47px 0px 0px 800px;\r\n"
						+ "            color: #0c498f;\r\n"
						+ "            text-align: left;\r\n"
						+ "        }\r\n"
						+ "        form h5{\r\n"
						+ "        	   margin : -147px 0px 0px -839px;\r\n"
						+ "            color: #0c498f;\r\n"
						+ "            text-align: center;\r\n"
						+ "        }\r\n"
						+ "        form a{\r\n"
						...
						+ "                </tr>"
						+ "            </table>\r\n"
						+ "            <h5><i class=\"fa fa-user-times\" aria-hidden=\"true\"></i> Do you want to Remove this Student ?</h5>\r\n"
						+ "			   <a href=\"RemoveStudent?fetchstudentId="+s_id+"\">REMOVE STUDENT</a>\r\n"
			    ...
			    printWriter.print("<!DOCTYPE html>\r\n"
			            ...
			            + "            <h2>ADMIN DASHBOARD</h2>\r\n"
			            + "            <p>STUDENT NOT FOUND. <br><br> You may handle Student Operations here. </p> \r\n"
			            + "            <div>\r\n"
